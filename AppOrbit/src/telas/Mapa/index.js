        ...
        const fetchOrbita = async () => {
            try {
                const response = await axios.get(
                    `http://10.239.0.240/appTcc/listar-orbitas.php?id=${orbitaId}`
                );
            ...
            dados.membro.forEach(membro => {
              ...
              if (!isNaN(lat) && !isNaN(lon) && lat !== 0 && lon !== 0) {
                ...
                var customIcon = L.divIcon({
                    ...
                    html: \`
                      <div class="marker-container">
                        <img src="http://10.239.0.240/appTcc/uploads/\${membro.foto}" 
                             class="marker-img"
                ...
                if (membro.foto && membro.foto !== '') {
                  popupContent += '<img src="http://10.239.0.240/appTcc/uploads/' + 
                                 membro.foto + 
