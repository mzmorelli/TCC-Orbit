...
try { 
    ...
    if (isset($_FILES['imagem'])) { 
        ...
        if (move_uploaded_file($file['tmp_name'], $targetPath)) { 
            ...
            error_log("Dados recebidos: " . print_r($postData, true));
            ...
            $query->bindValue(":usuario_id", $postData['usuario_id'] ?? 1); 
            ...
            if ($query->execute()) { 
                ...
                $response['message'] = 'Erro ao inserir no banco de dados: ' . implode(', ', $query->errorInfo()); 
            }
        } else {
